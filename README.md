...
* [Installing CodeReady Workspaces in TLS mode with self-signed certificates](https://access.redhat.com/documentation/en-us/red_hat_codeready_workspaces/2.1/html/installation_guide/installing-codeready-workspaces-in-tls-mode-with-self-signed-certificates_crw)
...
* Update Routes with TLS support
* Move project ocp-sample-flask-helm -to- helm-simple-flask-example
* Move project ocp-sample-flask-docker -to- docker-simple-flask-example
* Check Bootstrap, not BootStrap References
* Move Artifactory into separate project, remove references 
